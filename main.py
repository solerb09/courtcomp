...
'''BRANDON'''
merged_df.dropna(inplace=True)  # Drop rows with missing values in selected features
...
''''
REMOVE DUPLICATES AND HIGHLIGHT MOST OVERPAID AND UNDERPAID PLAYERS HERIK
'''
...
'''
    BAR CHART DISPLAYING 5 PLAYERS QUIN
'''
...
SHOWING IMAGES OF PLAYERS ON SCATTER PLOT QUIN
